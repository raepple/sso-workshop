...
| 32 | Change the SAP client id in the **URL of the request** field to the number of your team's client (e.g. "*?sap-client=008*") and click **Save**.<br/><br/>The issue is now fixed and the step details are shown. The step follows the [documentation for the SAML 2.0 Bearer Assertion Flow](https://help.sap.com/doc/saphelp_nw74/7.4.16/en-US/12/41087770d9441682e3e02958997846/content.htm) from SAP.<br/><br/>Click **Save**.| ![](images/0032.png) |
